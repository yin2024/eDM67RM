...
public class BookAccessBean implements Serializable {
    ...
    public BookAccessBean() throws ServletException, IOException, NamingException {
	...
	String createString = "Create Table eBook " + "(bookID int NOT NULL IDENTITY Primary Key , "
		+ " title			varchar(50), " + " author    	varchar(28), "
		+ " price			money, " + " discount		money, " + " companyID		int, "
		+ " image  		varchar(20), " + " bookNo 		varchar(20), "
		+ " CoverImage   	image " + " ) ";
